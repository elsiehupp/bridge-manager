...
export const templateName = (bridgeName: string) string {
	return fmt.Sprintf("%s.tpl.yaml", bridgeName)
}

export const IsSupported = (bridgeName: string) bool {
	return tpl.Lookup(templateName(bridgeName)) != nil
}

export const Generate = (bridgeName: string, params Params) (string, error) {
